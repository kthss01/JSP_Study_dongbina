	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">컴퓨터개론&nbsp;<small>김태훈</small></div>
			...
			<div class="card-body">
				<h5 class="card-title">
					정말 좋은 강의에요.&nbsp;<small>(2021년 여름학기)</small>
				</h5>
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					나쁘지 않은 것 같습니다.&nbsp;<small>(2021년 가을학기)</small>
				</h5>
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					강의력이 제일 좋은 강의에요.&nbsp;<small>(2021년 2학기)</small>
				</h5>
